...
gc = gspread.oauth(credentials_filename='C:/Users/OCONNORB/AppData/Local/gspread/python-pull-wxstation-dmforms-1c0dcc60196b.json')
...
df_table = df.iloc[-num_entries:, :].copy()
